...
public class String_Concatenation_Performance {
    public static void main(String[] args) {
        ...
        System.out.println("Time taken by String Concatenation: " + (end - start) + " nanoseconds");

        start = System.nanoTime();
        concatenatedString = concatenateUsingStringBuilder(arr);
        end = System.nanoTime();

        System.out.println("Time taken by StringBuilder Concatenation: " + (end - start) + " nanoseconds");

        start = System.nanoTime();
        concatenatedString = concatenateUsingStringBuffer(arr);
        end = System.nanoTime();

        System.out.println("Time taken by StringBuffer Concatenation: " + (end - start) + " nanoseconds");
