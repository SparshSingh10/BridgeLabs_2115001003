...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        employees.add(new FullTimeEmployee(101, "Amit", 50000, "Development", 70));
        employees.add(new PartTimeEmployee(102, "Arun", 20000, "Testing", 60));
        ...
        for (Employee employee : employees) {
            ...
            if (employee instanceof FullTimeEmployee) {
                ...
                ((PartTimeEmployee) employee).getDepartmentDetails();
            }
